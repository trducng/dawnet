...
from lora_train import suggested_lora, lora_named_parameters, replace_linear_to_lora_linear

class LoRADPO(FTRecipeInterface):
    """
...
if __name__ == "__main__":
  cfg = OmegaConf.load("lora_dpo_train.yaml")
  recipe = LoRADPO(cfg=cfg)
  recipe.setup(cfg=cfg)
  recipe.train()
